В этом проякте я реализовал механические часы с будильником на С++ с использование фреймворка WinForms
...
P.S. Все исходные картинки лежат в папке "resources"
...
Я по тегу определяю в каком положении сейчас находится кнопка и в зависимости от этого делаю следующее:
...
----------------------------------------
ПРИ НАЖАТИИ НА КНОПКУ (старт/стоп) в System::Void timer2_Tick()
----------------------------------------

При каждой итерации таймера:
1. я получаю повое время, на 1 секунду больше
...
cbDarkTheme_CheckedChanged() и cbLightTheme_CheckedChanged() - смена темы
